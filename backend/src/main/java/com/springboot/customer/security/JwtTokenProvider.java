package com.springboot.customer.security;
...
import com.springboot.customer.exception.CustomerAPIException;
...
public class JwtTokenProvider {
    ...
    public boolean validateToken(String token){
        try{
            ...
            throw new CustomerAPIException(HttpStatus.BAD_REQUEST, "Invalid JWT signature");
